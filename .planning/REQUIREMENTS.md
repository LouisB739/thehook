...
- [x] **CAPT-04**: Extraction produces structured markdown: session summary, conventions discovered, architecture decisions
- [x] **CAPT-05**: On timeout or LLM failure, a stub summary is written with raw transcript metadata (graceful degradation)
- [x] **CAPT-06**: Extraction prompt targets specific knowledge types (conventions, ADRs) — not raw observation capture
